...
#include <memory>
#include "../src/ui/widgets/BottomBar.h"
...
QT_MOC_LITERAL(4, 37, 14) // "addCardClicked"

    },
    "BottomBar\0startClicked\0\0pauseClicked\0"
    "addCardClicked"
};
...
void BottomBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->addCardClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BottomBar::startClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BottomBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BottomBar::pauseClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (BottomBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BottomBar::addCardClicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void BottomBar::startClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void BottomBar::pauseClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void BottomBar::addCardClicked()
{
