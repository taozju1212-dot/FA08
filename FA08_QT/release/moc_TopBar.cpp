...
#include <memory>
#include "../src/ui/widgets/TopBar.h"
...
QT_MOC_LITERAL(1, 7, 10), // "tabChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "index"
QT_MOC_LITERAL(4, 25, 17), // "alertsBellClicked"
QT_MOC_LITERAL(5, 43, 11) // "updateClock"

    },
    "TopBar\0tabChanged\0\0index\0alertsBellClicked\0"
    "updateClock"
};
...
void TopBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->alertsBellClicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBar::tabChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBar::alertsBellClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TopBar::tabChanged(int _t1)
{
